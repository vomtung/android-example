...
public class PieChart extends ViewGroup {
    ...
    private void init() {
        ...
        if (this.isInEditMode()) {
            ...
            addItem("Annabelle", 3, res.getColor(R.color.blue));
            addItem("Brunhilde", 4, res.getColor(R.color.green));
            addItem("Carolina", 2, res.getColor(R.color.white));
            addItem("Dahlia", 3, res.getColor(R.color.yellow));
            addItem("Ekaterina", 1, res.getColor(R.color.red));
        }
